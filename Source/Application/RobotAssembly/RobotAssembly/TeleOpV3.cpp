...
private:
	...
	void UpdateVariables()
	{
		...
		SmartDashboard::PutNumber("Drive/Rotation Velocity", m_Entity.GetCurrentAngularVelocity());
...
void TeleOp_V3::Reset()
{
	m_Tele_Internal->Reset();
}
void TeleOp_V3::init()
{
	m_Tele_Internal = std::make_shared<Test_Swerve_Rotary>();
	m_Tele_Internal->init();
}
void TeleOp_V3::Start()
{
